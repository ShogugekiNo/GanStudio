        ...
        return (
            <div className={classes.root}>
                ...
                >
                    ...
                    <Button  className={classes.button} onClick={this.handleModalOpen}>CHECKOUT</Button>
                </Drawer>
                ...
                <Modal
                    ...
                    <div style={getModalStyle()} className={classes.paper}>
                        <Grid container justify = "center">
                            ...
                            <Button  className={classes.button} component={Link} to="/success">Confirm Order</Button>
                        </Grid>   
